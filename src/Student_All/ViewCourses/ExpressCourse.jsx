...
import { Select, MenuItem, FormControl, InputLabel, Typography, Box, Grid, Button, Dialog, DialogActions, DialogContent, DialogTitle , FormControlLabel , Checkbox} from '@mui/material';
import ReactLecture1 from "../Lectures/React-L-1.mp4";
import ReactLecture2 from "../Lectures/React-L-2.mp4";
import StudentLayout from '../LAYOUT/StudentLayout';

function ExpressCourse() {
  ...
  // Handle lecture selection and reset state
  ...
  // Get the questions based on the selected lecture
  const getQuestions = () => {
  ...
  // Handle time update and check if a question is due (for lecture videos)
  ...
  const lectures = [
    ...
    { id: 2, title: 'Lecture 3', videoUrl: ReactLecture2 },
